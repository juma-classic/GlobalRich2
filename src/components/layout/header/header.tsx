                ...
                <>
                    ...
                    {isDesktop && (
                        <>
                            ...
                            <Button tertiary onClick={handleLogout} className='logout-button' title='Logout'>
                                <svg
                                    width='16'
                                    height='16'
                                    viewBox='0 0 24 24'
                    ...
                    <Button
                        ...
                        onClick={() => {
                            window.location.replace(
                                'https://oauth.deriv.com/oauth2/authorize?app_id=117918&l=EN&brand=globaltrades'
                            );
                        }}
                    >
                ...
                >
                    {theme === 'theme--light' ? (
                        <svg width='20' height='20' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                            ...
                            <path
                                d='M12 1v3M12 20v3M23 12h-3M4 12H1M20.5 3.5l-2.1 2.1M5.6 18.4l-2.1 2.1M20.5 20.5l-2.1-2.1M5.6 5.6L3.5 3.5'
                                stroke='currentColor'
                                strokeWidth='2'
                                strokeLinecap='round'
                            />
